...
- (IBAction)saveButtonTouched:(id)sender {
    if (![self.nameTextField.text isEqualToString:@""] && self.datePicker.date) {
        [self.date setValue:[NSDate dateWithTimeIntervalSinceNow:0] forKey:@"createdAt"];
        [self.date setValue:[NSDate dateWithTimeIntervalSinceNow:0] forKey:@"updatedAt"];
        ...
        [self.date setValue:[[SDCoreDataController sharedInstance] writeId] forKey:@"writeId"];
